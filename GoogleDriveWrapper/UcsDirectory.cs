...
{
    public class UcsDirectory : IUcsDirectory
    {
        public AbUcsDirectoryInfo CreateDirectory(string path)
        {
            throw new NotImplementedException();
        }

        public AbUcsDirectoryInfo CreateDirectory(string path, DirectorySecurity directorySecurity)
        {
            throw new NotImplementedException();
        }
        ...
        public AbUcsDirectoryInfo GetParent(string path)
        {
            throw new NotImplementedException();
        }
